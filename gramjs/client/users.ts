...
>(client: SrooshClient, inputPeer: T): Promise<R> {
...
/** @hidden */
export async function isBot(client: SrooshClient) {
...
/** @hidden */
export async function isUserAuthorized(client: SrooshClient) {
    try {
...
/** @hidden */
export async function _getPeer(client: SrooshClient, peer: EntityLike) {
    if (!peer) {
        return undefined;
    }
...
/** @hidden */
export async function _getInputDialog(client: SrooshClient, dialog: any) {
    try {
...
/** @hidden */
export async function _getInputNotify(client: SrooshClient, notify: any) {
    try {
...
/** @hidden */
export function _selfId(client: SrooshClient) {
