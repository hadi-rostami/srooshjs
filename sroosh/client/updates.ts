...
/** @hidden */
export function on(client: SrooshClient, event?: EventBuilder) {
...
/** @hidden */
export function listEventHandlers(client: SrooshClient) {
...
/** @hidden */
export async function _updateLoop(client: SrooshClient) {
    let lastPongAt;
